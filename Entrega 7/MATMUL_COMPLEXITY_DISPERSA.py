from numpy import *
from numpy import float32,float64,double
...
# =========================================
#     EJECUTO MATMUL MATRICES DISPERSAS
# =========================================
...
# =========================================
#     GRAFICO MATMUL MATRICES DISPERSAS
# =========================================
...
plt.tight_layout()
plt.savefig('MATMUL COMPLEXITY MATRICES DISPERSAS.png', dpi=600)
plt.show()
