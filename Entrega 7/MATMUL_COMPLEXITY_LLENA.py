from numpy import *
from numpy import float32,float64,double,ones,array
...
# =========================================
#     EJECUTO MATMUL MATRICES LLENAS
# =========================================
...
# =========================================
#     GRAFICO MATMUL MATRICES LLENAS
# =========================================
...
plt.tight_layout()
plt.savefig('MATMUL COMPLEXITY MATRICES LLENAS.png', dpi=600)
plt.show()
