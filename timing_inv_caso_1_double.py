import scipy as sp
from scipy import matmul, rand,float64,float32,float16,int16,int32,int64, zeros
...
plt.savefig('timing_inv_caso_1_double.png', dpi=400)
plt.show()
